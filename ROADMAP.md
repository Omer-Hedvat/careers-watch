...
|---|---|---|---|---|---|
| Web App v1 | `WEBAPP_SPEC.md` | P2 | `not-started` | 0 wrapped · 0 completed · 0 in-progress · 12 not-started | 12 |
...
|---|---|---|---|---|
| Fix Viola Getro duplicate jobs — dedupe by apply_url before scoring | `future_devs/VIOLA_GETRO_DEDUP_SPEC.md` | S | `not-started` | — |
| Rescore existing digest with updated profile | `future_devs/RESCORE_EXISTING_SPEC.md` | S | `not-started` | — |
...
| Feature | Spec | Effort | Status | Depends on |
|---|---|---|---|---|
| [webapp] Project scaffold — Next.js + FastAPI + Supabase schema | `future_devs/WEBAPP_SCAFFOLD_SPEC.md` | M | `not-started` | — |
...
| `future_devs/WEBAPP_SCAFFOLD_SPEC.md` | P2 — Project scaffold + Supabase schema |
